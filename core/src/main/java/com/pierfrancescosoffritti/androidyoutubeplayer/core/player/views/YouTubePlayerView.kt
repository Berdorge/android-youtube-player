...
class YouTubePlayerView(
    ...
    private val fullscreenHelper
        get() = legacyTubePlayerView.fullscreenHelper
    ...
    /**
     * Adds a [FullscreenListener] to the view.
     *
     * [FullscreenListener.onYouTubePlayerEnterFullScreen] and [FullscreenListener.onYouTubePlayerExitFullScreen]
